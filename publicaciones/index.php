...
<head>
		...
		const desc =$("#pub_descripcion").val();
			...
			$.ajax({
				...
				success:(data)=>{
                    ...
                    if(data[0].pub_estado=='alegree'){
                    	$(".cont_publicacion").remmoveClass("bg-primary");
                    	$(".cont_publicacion").remmoveClass("bg-warning");
                        $(".cont_publicacion").addClass("bg-succes");
                          }	
                          	if(data[0].pub_estado=='enojado'){
                    	$(".cont_publicacion").remmoveClass("bg-succes");
                    	$(".cont_publicacion").remmoveClass("bg-primary");
	...
	<body >
		<h1 class="bg-success">VN- instragam</h1>
		<div class="container">
			<div class="row">
				<div class="col-md-6">
